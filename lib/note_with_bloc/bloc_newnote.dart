...
import '../notewithprovider/note_provider.dart';
import 'note_bloc.dart';


class BlocNewnote extends StatefulWidget{
  @override
  State<BlocNewnote> createState() => _BlocNewnoteState();

}

class _BlocNewnoteState extends State<BlocNewnote> {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(onTap: () {
                          ...
                          BlocProvider.of<NoteBloc>(context).add(addNote(title, desc, date));
