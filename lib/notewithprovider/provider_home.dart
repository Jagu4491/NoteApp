...
class _ProviderHomeState extends State<ProviderHome> {
 ...
 return Scaffold(
   ...
   floatingActionButton: FloatingActionButton(
     onPressed: () {
       Navigator.push(
           context, MaterialPageRoute(builder: (context) => ProviderNewnote()));
     },
     child: Icon(
       Icons.add,
       color: Colors.white,
  ...
  Widget body(BuildContext context) {
    return Expanded(
      child: Consumer(
        builder: (_,__,___) {
          notes=context.watch<NoteProvider>().myData;
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => ProviderDescriptionpage(title,desc,date)));
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          OutlinedButton(onPressed: (){
                                           Provider.of<NoteProvider>(context,listen: false).updateNote(notetitlecontroller.text, notedesccontroller.text,notedatecontroller.text,columnid);
