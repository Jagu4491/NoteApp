...
class ProviderDescriptionpage extends StatefulWidget {
  var title;
  var date;
  var des;

  ProviderDescriptionpage(this.title,this.date,this.des);

  @override
  State<ProviderDescriptionpage> createState() => _ProviderDescriptionpage();
}

class _ProviderDescriptionpage extends State<ProviderDescriptionpage> {
  @override
