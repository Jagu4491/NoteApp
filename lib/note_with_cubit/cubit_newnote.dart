...
class CubitNewnote extends StatefulWidget{
  @override
  State<CubitNewnote> createState() => _CubitNewnoteState();

}

class _CubitNewnoteState extends State<CubitNewnote> {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        context.read<NoteCubit>().addNote(title, desc, date);
