...
class CubitDescriptionpage extends StatefulWidget {
  var title;
  var date;
  var des;

  CubitDescriptionpage(this.title,this.date,this.des);

  @override
  State<CubitDescriptionpage> createState() => _CubitDescriptionpage();
}

class _CubitDescriptionpage extends State<CubitDescriptionpage> {
  @override
