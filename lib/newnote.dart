         ...
         child: InkWell(
             ...
             child: Icon(Icons.arrow_back_ios_new_outlined,size: 30,color:Colors.white)),
                 ...
                 InkWell(onTap: (){
                   ...
                   child: Container(
                     ...
                     child: Center(
                         child: Text('Save',style: text20(tcolor: Colors.white,tfontwt: FontWeight.bold),)),
                   ),
                 )
               ],
           ...
           Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                label: Text('Title',style:text34(tcolor:Colors.white.withOpacity(0.6),tfontwt: FontWeight.bold) ,),
              ),
            ),
           ...
           TextField(
             ...
             decoration: InputDecoration(
               ...
               fillColor: maincolor.bgcolor,
               border: InputBorder.none,
               label: Text('Type Something....',style: text20(tcolor: Colors.white.withOpacity(0.6)),)
             ),
   ),
           TextField(
             style: t25(tcolor: Colors.white70),
             ...
             decoration: InputDecoration(
               ...
               fillColor: maincolor.bgcolor,
               border: InputBorder.none,
               label: Text('Date here.....',style: text20(tcolor: Colors.white.withOpacity(0.6)))
             ),
